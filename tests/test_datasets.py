    ...
    two_wiki_data = [
        {
            ...
            "context": [
                [
                    "Entity A",
                    ["Sentence 1 about Entity A.", "Sentence 2 about Entity A."],
                ],
                [
                    "Entity B",
                    ["Sentence 1 about Entity B.", "Sentence 2 about Entity B."],
                ],
            ],
            "evidences": [
        ...
        },
        {
            ...
            "context": [["Entity C", ["Sentence 1 about Entity C."]]],
            "evidences": [["Entity C", "is_a", "Type Y"]],
    ...
    hotpot_data = [
        {
            ...
            "context": [
                [
                    "Country X",
                    ["Country X is a nation.", "The capital of Country X is City Y."],
                ],
...
def test_two_wiki_multihopqa():
    ...
    try:
        ...
        dataset = TwoWikiMultiHopQADataset(
            two_wiki_file, task_type="graph_construction"
        )
